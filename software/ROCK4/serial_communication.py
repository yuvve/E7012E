...
vals = {"current_speed": "-", "forward_distance": "-", "left_distance": "-", "right_distance": "-"}
...
def _receive_loop():
    while True:
        ...
        if len(parts) < 4:
            continue
        with val_lock:
            vals["current_speed"], vals["forward_distance"], vals["left_distance"], vals["right_distance"] = parts[:4]
